...
class FaqReview extends React.Component{
    constructor(){
        super();
        this.state={
            cur_step:1,
            ...
            faq1:'After each fulfilled appointment, we send a request for a '
                +'feedback to the patient about his or her experience. We do '
                +'moderate but allow you and the doctor to report a review if you '
                +'think it violates our policy; these reviews help other patients '
                +'make an informed choice. Locals Reviews are...',
            faq2:'After your appointment is fulfilled, you will receive an email or an '
                +'SMS as registered in your account  . It will include a  link to '
                +'follow in order to review your doctor!  You can always sign into '
                +'your Tourmed account and click "Leave Feedback" in "'
                +'my recent appointments" section.'
        }
